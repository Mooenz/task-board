      ...
      >
        <div className="flex flex-col h-full overflow-auto p-4 sm:p-5.5">
          <div className="flex items-start justify-between mb-5">
            ...
            <button
              className="flex justify-center items-center h-9 w-9 outline outline-dark rounded-xl hover:bg-orange-light hover:outline-orange active:scale-95 focus:outline-orange focus-within:outline-orange focus-visible:outline-orange transition-all duration-300 cursor-pointer"
              onClick={handleCloseAside}
            >
